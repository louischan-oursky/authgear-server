...
type AuthenticatorService interface {
	...
	VerifyWithSpecPure(info *authenticator.Info, spec *authenticator.Spec, options *facade.VerifyOptions) (updated *authenticator.Info, requireForceChange bool, err error)
	VerifyOneWithSpecPure(userID string, authenticatorType model.AuthenticatorType, infos []*authenticator.Info, spec *authenticator.Spec, options *facade.VerifyOptions) (info *authenticator.Info, updated *authenticator.Info, requireForceChange bool, err error)
