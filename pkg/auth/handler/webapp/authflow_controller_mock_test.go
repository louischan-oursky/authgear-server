...
func (m *MockAuthflowControllerAuthflowHTTPClient) Input(w http.ResponseWriter, stateToken string, input map[string]interface{}) (*authflowclient.FlowResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Input", w, stateToken, input)
	ret0, _ := ret[0].(*authflowclient.FlowResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockAuthflowControllerAuthflowHTTPClientMockRecorder) Input(w, stateToken, input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Input", reflect.TypeOf((*MockAuthflowControllerAuthflowHTTPClient)(nil).Input), w, stateToken, input)
}
